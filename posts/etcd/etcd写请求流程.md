...
![](etcd写请求流程/8b6dfa84bf8291369ea1803387906c72.png)
...
![](etcd写请求流程/dc8e373e06f2ab5f63a7948c4a6c8554.png)
...
![](etcd写请求流程/479dec62ed1c31918a7c6cab8e6aa18d.png)
...
![](etcd写请求流程/7f13edaf28yy7a6698e647104771235b.png)
...
我们知道 etcd 是个 MVCC 数据库，每次更新都会生成新的版本号。如果没有幂等性保护，同样的命令，一部分节点执行一次，一部分节点遭遇异常故障后执行多次，则系统的各节点一致性状态无法得到保证，导致数据混乱，这是严重故障。
...
![](etcd写请求流程/a19a06d8f4cc5e488a114090d84116ff.png)
...
最后我们来小结一下 etcd 的写请求流程，重点介绍了 Quota、WAL、Apply 模块。
...
随后介绍了 Apply 模块基于 consistent index 和事务实现了幂等性，保证了节点在异常情况下不会重复执行重放的提案。
